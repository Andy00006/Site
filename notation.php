        ...
        <main>
            ...
            <section class="bloc-pourboire">
                ...
                <div class="choix-pourboire">
                    <input type="radio" name="pourboire" id="p1" value="1"><label for="p1">1€</label>
                    <input type="radio" name="pourboire" id="p2" value="2"><label for="p2">2€</label>
                    <input type="radio" name="pourboire" id="p5" value="5"><label for="p5">5€</label>
                    <input type="radio" name="pourboire" id="p-perso" value="autre"><label for="p-perso">Autre</label>
                </div>
            </section>
